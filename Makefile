...
#
CFLAGS = -O2 -DARCH="$(ARCH)" -DSTDC_HEADERS -DSTD_LOGGING
# This is for 32-bit build on 64-bit host
ifeq ($(ARCH), i386)
CFLAGS += -m32 -fPIC -I/usr/include
endif
...
GAME_SRCS = \
	g_ai.c g_cmds.c g_combat.c g_func.c g_items.c g_main.c \
	g_misc.c g_monster.c g_phys.c g_save.c g_spawn.c g_svcmds.c g_target.c \
	g_trigger.c g_turret.c g_utils.c g_weapon.c \
	m_actor.c m_berserk.c m_boss2.c m_boss3.c m_boss31.c m_boss32.c m_brain.c \
	...
	p_client.c p_hud.c p_trail.c p_view.c \
	p_weapon.c q_shared.c stdlog.c camclient.c ctc.c gslog.c menu.c tctc.c
