...
!IF "$(CFG)" != "game - Win32 TCTC Release" && "$(CFG)" != "game - Win32 TCTC Debug"
...
CPP_PROJ=/nologo /G5 /MD /W3 /GX /O2 /I "./" /I "./chicken" /I "./stdlog" /I "./q2cam" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "STD_LOGGING" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\game.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
CPP_PROJ=/nologo /G5 /MDd /W3 /GX /ZI /I "./" /I "./chicken" /I "./stdlog" /I "./q2cam" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "STD_LOGGING" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\game.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
MTL_PROJ=/nologo /D "DEBUG" /mktyplib203 /win32 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\game.bsc" 
BSC32_SBRS= \
	"$(INTDIR)\camclient.sbr" \
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winmm.lib /nologo /base:"0x20000000" /subsystem:windows /dll /incremental:yes /pdb:"$(OUTDIR)\gamex86.pdb" /debug /machine:I386 /def:".\game.def" /out:"$(OUTDIR)\gamex86.dll" /implib:"$(OUTDIR)\gamex86.lib" 
DEF_FILE= \
	".\game.def"
LINK32_OBJS= \
	"$(INTDIR)\camclient.obj" \
...
$(DS_POSTBUILD_DEP) : "$(OUTDIR)\gamex86.dll" "$(OUTDIR)\game.bsc"
   copy .\debug\gamex86.dll c:\quake2\ctc\gamex86.dll
