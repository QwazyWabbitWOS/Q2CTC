...
//
#define CHICKEN_TIMER		2.0f
#define CHICKEN_MINSPEED	400.0f
#define CHICKEN_MAXSPEED	600.0f
#define EGG_SPEED			1000.0f	// Speed of egg
...
// Teamplay Functions
//
void Chicken_TeamMenuCreate(void);
void Chicken_PlayerSelectMenuCreate(void);
